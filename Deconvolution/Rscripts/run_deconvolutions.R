...
source('RScripts/tdi_deconvolve_pkg.R') #add full path of the tdi_deconvolve_pkg.R provided in the same RScripts folder

# change below if running a subset of tools
tools_to_run=c('cibersort','xcell','ssgsea','mcp','sgl', 'epic','quantiseq', 'timer')[2:8]  # [2:8] runs without Cibersort. To enable Cibersort, add path to Cibersort binary in tdi_deconvolve_methods.R and remove [2:8] from this line 
...
cancer=args[4]  #TCGA cancer type, required for TIMER
